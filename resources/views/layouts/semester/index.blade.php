...
@section('container')
    ...
    <div class="page-heading">
        <h3>Tambah Nilai Semester Mahasiswa</h3>
    </div>
        ...
        <div class="col-3">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Nilai Semester</h4>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" id="nama" class="form-control"
                                            placeholder="Nama Mahasiswa" name="nama"
                                            value="{{ old('nama', $data['nama']) }}">
                                        <input hidden type="text" id="id_mahasiswa" class="form-control"
                                            name="id_mahasiswa" value="{{ old('id_mahasiswa', $data['id']) }}">
                                    </div>
                                </div>
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
